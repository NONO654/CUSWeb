<%--  emxProjectManagementDragAndDrop.jsp
   ...
   Copyright (c) Dassault Systemes, 1992-2019 .All rights reserved
...
<%
    ...
    String sLabelReference       = i18nNow.getI18nString("emxFramework.Relationship.Reference_Document", "emxFrameworkStringResource", sLang);
...
<div id="pageHeadDiv">
    <table>
        <tbody><tr><td class="page-title"><h2 title="Drop Files"><%=sFormTitle%></h2><h3 title="Name"><%=sObjName%></h3></td>
                   <td class="functions">
                    <table>
