...
<%
	...
	try{
		String objectId = "";
		String strSelectedCollections = request.getParameter("objectId");
		...
		objectId = strSelectedCollections;
		
		String mode = request.getParameter("mode");
		System.out.println("mode11__" + mode);
	
		
		loadPage = "CSSCSelectionFrame.jsp?objectId=" + objectId + "&mode=" + mode+"&parentId="+parentId;
	} catch (Exception ex) {
		ex.printStackTrace();
	} 
