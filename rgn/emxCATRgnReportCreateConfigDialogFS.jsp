...
<%
	...
	contentURLBuf.append("emxCATRgnReportCreateConfigDialog.jsp");
	...
	String PageHeading = "emxRGN.Title.CreateReportStep3";

	// Marker to pass into Help Pages
	// icon launches new window with help frameset inside
	String HelpMarker = (mode != null && "edit".equalsIgnoreCase(mode)) ? "emxhelpreporteditconfig" : "emxhelpreportcreateconfig";
	fs.setSuiteKey("RGN");
