...
<%
	System.out.println("BEGIN emxProfilePrecondChooser.jsp");
	...
	String typeNLS = EnoviaResourceBundle.getProperty(context,ProfileConstants.resourcesFile, new Locale(language),"emxProfile.Common.Precondition");
	...
	if(selectedId != null)
	{
		...
		if(sObjId != null) {
			...
			if(ProfileUtils.isTypeKindOf(context, objectType, Type.PLMPreCondCheck)){
				...
				%>
					...
					<script language="Javascript">
						...
						txtTypeDisp = objForm.elements['precond'];
						txtTypeDisp.value = "<%=parentName%>";
						txtTypeDisp = objForm.elements['precondvalue'];
						txtTypeDisp.value = "<%=parentName%>";
						txtTypeDisp = objForm.elements['precondOID'];
