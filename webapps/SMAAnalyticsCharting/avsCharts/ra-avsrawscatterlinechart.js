(function(GLOBAL) {
    if (typeof GLOBAL.DS.RAComponents.avsrawscatterlinechart !== 'undefined') {
        return;
    }
    ...
    avsChartPrototype.initialize = function(configuration) {
        GLOBAL.DS.RAComponents.avsrawscatterchart.initialize.call(
            this,
            configuration
        );
        if (configuration) {
    ...
    avsChartPrototype.preRender = function() {
        GLOBAL.DS.RAComponents.avsrawscatterchart.preRender.call(this);
    ...
    GLOBAL.DS.RAComponents.avsrawscatterlinechart = avsChartPrototype;
})(this);
