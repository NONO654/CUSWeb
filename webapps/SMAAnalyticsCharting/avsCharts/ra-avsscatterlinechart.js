(function(GLOBAL) {
    if (typeof GLOBAL.DS.RAComponents.avsscatterlinechart !== 'undefined') {
        return;
    }
    var NLSUtils = GLOBAL.DS.RAObjects.NLSUtils;

    var avsChartPrototype = {
        is: 'ra-avsscatterlinechart',
    ...
    avsChartPrototype.initialize = function(configuration) {
        GLOBAL.DS.RAComponents.avsscatterchart.initialize.call(
            this,
            configuration
        );
        if (configuration) {
    ...
    avsChartPrototype.preRender = function() {
        GLOBAL.DS.RAComponents.avsscatterchart.preRender.call(this);
    ...
    avsChartPrototype.renderControlPanel = function(panel) {
        GLOBAL.DS.RAComponents.avsscatterchart.renderControlPanel.call(
            this,
            panel
        );
        ...
        // Modify param panels
        this.controls.yControl.title('Y Scatter');
    ...
    avsChartPrototype.updateRequest = function() {
        ...
        for (var i = 0; i < this.parameters.yline.length; i++) {
            ...
            ySeries.aggregationType = that.controls.yLineControl.getAggregationType(
                i
            );
        ...
        if (type === 'byData') {
            ...
            if (this.parameters.colorline.dataType === 'STRING') {
                ...
                this.requestObject.chartRequest.charts[1].color.data.type =
                    'aggregation';
                this.requestObject.chartRequest.charts[1].color.data.aggregationType = that.controls.colorLineControl.getAggregationType();
    ...
    GLOBAL.DS.RAComponents.avsscatterlinechart = avsChartPrototype;
})(this);
