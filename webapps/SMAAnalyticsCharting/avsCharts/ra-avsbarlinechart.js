(function(GLOBAL) {
    if (typeof GLOBAL.DS.RAComponents.avsbarlinechart !== 'undefined') {
        return;
    }
    var NLSUtils = GLOBAL.DS.RAObjects.NLSUtils;

    var avsChartPrototype = {
        is: 'ra-avsbarlinechart',
    ...
    avsChartPrototype.initialize = function(configuration) {
        GLOBAL.DS.RAComponents.avsbarchart.initialize.call(this, configuration);
        if (configuration) {
        } else {
    ...
    avsChartPrototype.preRender = function() {
        GLOBAL.DS.RAComponents.avsbarchart.preRender.call(this);
    ...
    avsChartPrototype.renderControlPanel = function(panel) {
        GLOBAL.DS.RAComponents.avsbarchart.renderControlPanel.call(this, panel);
    ...
    GLOBAL.DS.RAComponents.avsbarlinechart = avsChartPrototype;
})(this);
