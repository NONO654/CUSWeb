...
function collectDrops(_ref6, draggableElement) {
  ...
  for (var _i = 0; _i < interactables.list.length; _i++) {
      ...
      if (_ref7.options.drag.enabled || _ref7.options.drop.enabled) {
  ...
  var gesture = {
    ...
    checker: function checker(pointer, event, interactable, element, interaction) {
      if (interaction.pointers.length >= 2) {
          ...
          for (var i = 1; interaction.pointers.length > i; i++) {

              if (interaction.pointers[0].downTarget === interaction.pointers[i].downTarget) {
                  return { name: 'gesture' };
              }
          }
      }
...
function __install_18(scope) {
  ...
  scope.interactions.eventMap.dragstart = function preventNativeDrag(event) {
    for (var _i2 = 0; _i2 < scope.interactions.list.length; _i2++) {
        ...
        if (_ref2.options.drag.enabled || _ref2.options.drop.enabled) {
...
function () {
  ...
  ___createClass_16(Interaction, [{
    ...
    value: function pointerDown(pointer, event, eventTarget) {
        ...
        var pointersI = 0;
        var newPointersArray = [];

        while (pointersI < this.pointers.length) {

            if (this.pointers[pointersI].pointer.target.isConnected) {
                newPointersArray.push(this.pointers[pointersI]);
            }

            pointersI++;
        }

      this.pointers = newPointersArray;
    ...
    interactables: {
      ...
      forEachMatch: function forEachMatch(element, callback) {
        ...
        for (var _i = 0; _i < this.list.length; _i++) {
          ...
          if (_ref.options.drag.enabled || _ref.options.drop.enabled) {
...
function set(_ref2) {
 ...
 // var restriction = getRestrictionRect(options.restriction, interaction, coords);
  ...
  var restriction = options.restriction !== '' ? getRestrictionRect(options.restriction, interaction, coords) : false;
