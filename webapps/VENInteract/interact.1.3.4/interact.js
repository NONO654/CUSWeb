...
var restrict = {
  ...
  set: function set(_ref2) {
    ...
    var restriction = options.restriction !== '' ? getRestrictionRect(options.restriction, interaction, page) : false;
