...
define('DS/SMAExeCOSAdmin/Views/StationResultsPropertiesView', [
    'UWA/Core',
...
//            this.listenTo(this.model, 'onChange', this.onModelChange);
        ...
        _initForm : function() {
            ...
            var formOptions = {
                className : 'vertical',
                fields : function() {
      				   return FormUtils.getStationResultsFields(model, false, model.get('serverName'), true);
               }
            };
        ...
        onRender : function() {
            var container = this.getElement('.station-results-properties-subcontainer');
    ...
    return StationResultsProperties;
});
