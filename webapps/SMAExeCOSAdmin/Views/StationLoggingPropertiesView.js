...
define('DS/SMAExeCOSAdmin/Views/StationLoggingPropertiesView',  [
    'UWA/Core',
...
//            this.listenTo(this.model, 'onChange', this.onModelChange);
        ...
        _initForm : function() {
            ...
            var formOptions = {
                className : 'vertical',
                fields : function() {
      				   return FormUtils.getStationLoggingFields(model, false, model.get('serverName'), true);
               }
            };
        ...
        onRender : function() {
            var container = this.getElement('.station-logging-properties-subcontainer');
    ...
    return StationLoggingProperties;
});
