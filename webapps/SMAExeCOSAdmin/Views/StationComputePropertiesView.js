...
define('DS/SMAExeCOSAdmin/Views/StationComputePropertiesView', [
    'UWA/Core',
...
//            this.listenTo(this.model, 'onChange', this.onModelChange);
        ...
        _initForm : function() {
            ...
            var formOptions = {
                className : 'vertical',
                fields : function() {
      				   return FormUtils.getStationComputeFields(model, false, model.get('serverName'), true);
               }
            };
        ...
        onRender : function() {
            var container = this.getElement('.station-compute-properties-subcontainer');
    ...
    return StationComputeProperties;
});
