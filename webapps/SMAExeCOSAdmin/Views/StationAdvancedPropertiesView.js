...
define('DS/SMAExeCOSAdmin/Views/StationAdvancedPropertiesView',  [
    'UWA/Core',
...
//            this.listenTo(this.model,  'onChange',  this.onModelChange);
        ...
        _initForm : function() {
            ...
            var formOptions = {
                className : 'vertical',
                fields : function() {
      				   return FormUtils.getStationAdvancedFields(model,  false,  model.get('serverName'),  true);
               }
            };
        ...
        onRender : function() {
            var container = this.getElement('.station-advanced-properties-subcontainer');
    ...
    return StationAdvancedProperties;
});
