...
define('DS/SMAExeCOSAdmin/Views/StationGeneralPropertiesView', [
    'UWA/Core',
    ...
    var StationGeneralProperties = ItemView.extend({
        ...
        _initForm : function() {
            ...
            var formOptions = {
                className : 'vertical',
                fields : function() {
      				   return FormUtils.getStationGeneralFields(model, false, model.get('serverName'), true);
               }
            };
        ...
        onRender : function() {
            var container = this.getElement('.station-general-properties-subcontainer');
    ...
    return StationGeneralProperties;
});
