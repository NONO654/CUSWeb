...
define('DS/SMAExeCOSAdmin/Views/StationPropertiesView', [
    'UWA/Core',
...
//            this.listenTo(this.model, 'onChange', this.onModelChange);
        ...
        _initForm : function() {
            ...
            var formOptions = {
                className : 'vertical',
                fields : function() {
      				   return FormUtils.getStationFields(model, false, model.get('serverName'), true);
               }
            };
        ...
        onRender : function() {
            var container = this.getElement('.station-properties-subcontainer');
