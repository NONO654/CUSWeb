define('DS/ENOXCAD_Save/controllers/XCAD_SaveAsNewCmd', 
[
	'UWA/Core', 
    ...
    var SaveAsNewCmd = {
    		...
    		_id:null,
    		_isEnable:null,
             init : function(id,savasnewBTn) {
            	 this._isEnable=false;
        	this._SaveAsNewButton=savasnewBTn;
        	this._id=id;
			...
			var that=this
            this._SaveAsNewButton.addEventListener('buttonclick', function (event){
            	that.execute();
        });
        },
        execute : function() {
			...
			XCAD_InteractionsWEB_CAD.sendMessageToCad('SaveAsNew', '1.0', content);
        },        
        updateAvailability : function(selectedNodes) {
            ...
            if (this._isEnable)
				this._SaveAsNewButton.elements.button.dsModel.disabled=false;
			else
				this._SaveAsNewButton.elements.button.dsModel.disabled=true;
        } 
    };
