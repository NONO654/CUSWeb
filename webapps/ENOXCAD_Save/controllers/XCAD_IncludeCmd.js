define('DS/ENOXCAD_Save/controllers/XCAD_IncludeCmd', 
[
	'UWA/Core', 
    ...
    var IncludeCmd = {
    		...
    		_id:null,
    		_isEnable:null,
             init : function(id,includeBTn) {
            	 this._isEnable=false;
        	this._IncludeButton=includeBTn;
        	this._id=id;
			...
			var that=this
            this._IncludeButton.addEventListener('buttonclick', function (event){
            	that.execute();
        });
        },
        execute : function() {
        ...
        updateAvailability : function(selectedNodes) {
            ...
            if (this._isEnable)
				this._IncludeButton.elements.button.dsModel.disabled=false;
			else
				this._IncludeButton.elements.button.dsModel.disabled=true;
        } 
    };
