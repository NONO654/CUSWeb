...
(function webpackUniversalModuleDefinition(root, factory) {
    ...
    define('DS/VEN3DLeanHTML2CanvasJS/HTML2CanvasJS.1.0.0.a12/html2canvas', [], function() {
        return factory();
    });
})(this, function() {
...
var Bounds = exports.Bounds = function () {
    ...
    _createClass(Bounds, null, [{
        ...
        value: function fromClientRect(clientRect, scrollX, scrollY) {
            return new Bounds(Math.floor(clientRect.left + scrollX), Math.floor(clientRect.top + scrollY), Math.floor(clientRect.width), Math.floor(clientRect.height));
        }
    }]);
...
var getImage = function getImage(node, resourceLoader) {
    if (node instanceof node.ownerDocument.defaultView.SVGSVGElement || node instanceof SVGSVGElement) {
        ...
        for (var n of svgElem) {
            if (window.getComputedStyle(node, null).getPropertyValue('font-family')) {

                n.setAttribute('font-family', window.getComputedStyle(node, null).getPropertyValue('font-family'));
                n.replaceWith(n);
            }
        }
    ...
    _createClass(DocumentCloner, [{
        ...
        value: function cloneNode(node) {
            ...
            if (node instanceof window.HTMLElement && clone instanceof window.HTMLElement) {
                ...
                _Util.copyCSSStyles(style, clone);
            }
            return clone;
        }
    }]);
