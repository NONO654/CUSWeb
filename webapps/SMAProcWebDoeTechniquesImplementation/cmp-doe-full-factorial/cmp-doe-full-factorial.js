/**
 * @class element:cmp-doe-full-factorial
 * @noinstancector
 * @description
 * This component implements the Full Factorial technique in DOE.
 * In a full-factorial design all combinations of all factors at all levels are evaluated.
 * Typically, the standard engineering practice is to systematically evaluate a grid of points requiring
 * n1×n2×n3×…ni (i = # factors, ni = # levels for factor i)
 * design point evaluations.
 * This practice provides extensive information for accurate estimation of factor and interaction effects.
 * However, it is often deemed cost-prohibitive because of the number of analysis required.
 */

require(['SMAProcWebDoeTechniquesBase/SMAProcDesignDriverFactorImpl'],
function (SMAProcDesignDriverFactorImpl) {
    'use strict';
    Polymer(/** @lends element:cmp-doe-full-factorial# */{
        is: 'cmp-doe-full-factorial',
        properties: /** @lends element:cmp-doe-full-factorial# */{
            /**
