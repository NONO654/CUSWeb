...
<%
        ...
        while(paraNames.hasMoreElements()){
			...
			if("fieldNameActual".equals(paraKey)){
				fieldNameActual = paraValue;
			}
        }
		
		
	
	String csddcTitle = "适用船型及适用范围";
	String loadPage = "";
	try{
		/*String objectId="";
		...
		loadPage = "CSSCSelectionFrame.jsp?objectId=" + objectId + "&mode=" + mode+"&fieldNameActual="+fieldNameActual;
	} catch (Exception ex) {
		ex.printStackTrace();
	} 
