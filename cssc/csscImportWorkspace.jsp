...
<%@page	import="com.matrixone.apps.domain.*,com.matrixone.apps.domain.util.*,matrix.util.*,matrix.db.Context,com.matrixone.servlet.Framework,java.io.PrintWriter,com.matrixone.apps.framework.ui.UIUtil"%>
...
<%
	String csddcTitle = "工作区导入";
	String loadPage = "";
	try{
		System.out.println("Import Workspace----------------->>>");
		
		String mode = request.getParameter("mode");
		String objectId = request.getParameter("objectId");
	
		loadPage = "csscImportWorkspace_2.jsp?mode=" + mode+"&objectId="+objectId;
	} catch (Exception ex) {
		ex.printStackTrace();
	} 
