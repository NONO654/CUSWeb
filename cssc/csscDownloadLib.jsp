...
<%
	...
	try{
			...
			programMap.put("relFilePath",tomcatPath);
			Map resultMap = (Map)JPO.invoke(context, "CSICImportTechnologyKnowledgeLib", new String [] { }, "exportLib", JPO.packArgs(programMap),Map.class);
