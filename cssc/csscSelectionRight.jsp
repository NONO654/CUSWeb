...
<link rel="stylesheet" type="text/css" href="css/slidernav.css?v=1.0.9" media="screen, projection" />
<script type="text/javascript" src="js/jquery-1.4.2.min.js?v=1.0.0"></script>
<script type="text/javascript" src="js/slidernav.js?v=1.0.0"></script>
...
/* demo */
.demo{width:70%;margin:20px auto;border-right：1px solid ;}
</style>


</head>
<body>
		<h3 style="text-align:center"><font style="color:black;font-family:Microsoft YaHei UI Light;font-weight:bold"><b>适用范围:</b></font></h3>
	<hr>	
<div class="demo">
		...
		<div class="slider-content">
			...
			<ul>
					<%
						...
						String shipName = (String)scopeList.get(i);
