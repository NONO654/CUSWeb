...
<% 
	...
	try {
		...
		System.out.println("mode33__" + mode);
					
		if (myfile.getFileExt().length()>0) {
			String temp_FileName = System.nanoTime() + "."+prefix;//这儿在日期字符串加上了一个标识符
			...
			Map resultMap = (Map)JPO.invoke(context, "CSICImportTechnologyKnowledgeLib", new String [] {}, "importLib", JPO.packArgs(paramMap),Map.class);
			String information = (String)resultMap.get("status");
			String objects = (String)resultMap.get("object");
