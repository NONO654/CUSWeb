...
<script src="../plugins/libs/jquery/2.0.0/jquery.min.js" >
</script>
...
<%
    ...
    if ((refreshAction == null) && (selectedRowId == null))
    {
        if("AssignConnector".equals(strMethodName))
        {
            %>
                <script>
                 //modaldialog.getWindowOpener().stepframe.portalframe.location.href
                 getTopWindow().getWindowOpener().parent.parent.location.href=
                	 getTopWindow().getWindowOpener().parent.parent.location.href;
                 getTopWindow().closeWindow();
                </script>
            <%
