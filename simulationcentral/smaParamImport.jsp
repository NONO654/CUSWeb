...
<%--
  smaParamImport.jsp Process import command found on the Simulation or 
...
<%
    ...
    String header = SimulationUtil.getI18NString(context,
        "smaSimulationCentral.ParamImportJsp.Header" );
...
<title><%=header %></title>
 ...
 <%
     ...
     String overwriteDup =  SimulationUtil.getI18NString(context,
         "smaSimulationCentral.Parameter.OverwriteDup");
     String skipDup =  SimulationUtil.getI18NString(context,
         "smaSimulationCentral.Parameter.SkipDup");
     ...
     DO.setId(objId);
     String sName = DO.getInfo(context,SELECT_TITLE);
     String pageHeader = SimulationUtil.getI18NString(context,
         "smaSimulationCentral.ImportParameter.Header");

     pageHeader = pageHeader + " " + sName;
     ...
     helpHTML.append("SMAParameters_ListImportParam"); // help marker
     helpHTML.append("', '");
...
<INPUT TYPE=hidden NAME=objectAction VALUE="parameterImport">
